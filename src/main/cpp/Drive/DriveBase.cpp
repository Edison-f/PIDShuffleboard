...
DriveBase::DriveBase(int l1, int l2,
	...
	frc::SmartDashboard::PutNumber("kP Left Velo get", K_P_LEFT_VEL);
	frc::SmartDashboard::PutNumber("kP Right Velo get", K_P_RIGHT_VEL);
	frc::SmartDashboard::PutNumber("kP Yaw Velo get", K_P_YAW_VEL);

	frc::SmartDashboard::PutNumber("kD Left Velo get", K_D_LEFT_VEL);
	frc::SmartDashboard::PutNumber("kD Right Velo get", K_D_RIGHT_VEL);
	frc::SmartDashboard::PutNumber("kD Yaw Velo get", K_D_YAW_VEL);
...
void DriveBase::TeleopWCDrive(Joystick* JoyThrottle, //finds targets for the Controller()
 ...
 //	led_solenoid->Set(false);
		...
		test_val = frc::SmartDashboard::GetNumber("test1 get", 0);
		frc::SmartDashboard::PutNumber("test1 disp", test_val);
	...
	k_p_left_vel = frc::SmartDashboard::GetNumber("kP Left Velo get", K_P_LEFT_VEL);
	k_p_right_vel = frc::SmartDashboard::GetNumber("kP Right Velo get", K_P_RIGHT_VEL);
	k_p_yaw_vel = frc::SmartDashboard::GetNumber("kP Yaw Velo get", K_P_YAW_VEL);

	test_val = frc::SmartDashboard::GetNumber("test1 get", 0);
	frc::SmartDashboard::PutNumber("test1 disp", test_val);

	k_d_left_vel = frc::SmartDashboard::GetNumber("kD Left Velo get", K_D_LEFT_VEL);
	k_d_right_vel = frc::SmartDashboard::GetNumber("kD Right Velo get", K_D_RIGHT_VEL);
	k_d_yaw_vel = frc::SmartDashboard::GetNumber("kD Yaw Velo get", K_D_YAW_VEL);

	frc::SmartDashboard::PutNumber("kP Left Velo", k_p_left_vel);
	frc::SmartDashboard::PutNumber("kP Right Velo", k_p_right_vel);
	frc::SmartDashboard::PutNumber("kP Yaw Velo", k_p_yaw_vel);

	frc::SmartDashboard::PutNumber("kD Left Velo", k_d_left_vel);
	frc::SmartDashboard::PutNumber("kD Right Velo", k_d_right_vel);
	frc::SmartDashboard::PutNumber("kD Yaw Velo", k_d_yaw_vel);
	...
	Controller(0.0, target_r, target_l, target_yaw_rate, k_p_right_vel,
		...
		0.0, 0.0, 0.0); // West Coast Drive Controller Func
}
...
//frc::SmartDashboard::PutNumber("yaw p", yaw_output);
	...
	if (false) {// frc::RobotState::IsAutonomous()) { //only want the feedforward based off the motion profile during autonomous. The root generated ones (in the if() statement) //should already be 0 during auton because we send 0 as refs
